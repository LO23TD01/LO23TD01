...
//			throw new Exception("L'utilisateur n'est � aucune table. il doit �tre � une table pour parler.");
		GameTable tableFull = userFull.getActualTable().getSame(this.tableList);
//		if(tableFull==null)
//			throw new Exception("L'utilisateur est � une table qui n'existe pas. La table doit exister pour parler.");
	...
	public void dropTable(GameTable table) {
		GameTable tableFull = table.getSame(this.tableList);
//		 if(tableFull==null)
//			 throw new Exception("La table n'existe pas. Il faut que la table existe pour la d�truire.");
		 for(User u : tableFull.getAllList())
		 {
			 User userFull = u.getSame(this.usersList);
//			 if(userFull==null)
//					 throw new Exception("L'utilisateur n'est pas connect�. Il faut �tre connect� pour se faire kick d'une table.");
...
//		 if(userFull==null)
//				 throw new Exception("L'utilisateur n'est pas connect�. Il faut �tre connect� pour quitter une table.");

//		 if(userFull.getActualTable()==null)
//			 throw new Exception("L'utilisateur n'est pas � une table. Il dtoi �tre � une table pour la quitter.");
		GameTable tableFull = userFull.getActualTable().getSame(this.tableList);
//		 if(userFull.getActualTable()==null)
//		 throw new Exception("L'utilisateur est � une table qui n'existe pas. La table doit exister pour quitter la table..");
...
//		 else if(userFull.getActualTable()!=null)
//			 throw new Exception("L'utilisateur est d�j� � une table. Il faut sortir de table avant d'en cr�er une nouvelle.");
	...
	public void disconnect(User user) {
		...
		System.out.print("Client déconnecté du serveur");
	}
	...
	public void connectUser(Profile profile) {
		...
		System.out.println("Client connecté sur le serveur");
	}
...
//		if(userFull.getActualTable()==null)
//			throw new Exception("L'utilisateur n'est � aucune table. il doit �tre � une table pour voter.");
		GameTable tableFull = userFull.getActualTable().getSame(this.tableList);
//		if(tableFull==null)
//			throw new Exception("L'utilisateur est � une table qui n'existe pas. La table doit exister pour voter.");
//		if(tableFull.getVote() || tableFull.getGameState().getState()!=State.END)
//			throw new Exception("Aucun vote pour rejouer en cours. Un vote doit �tre en cours pour voter");
//		if(tableFull.getVoteCasted().stream().filter(v->v.getUser().isSame(userFull)).count()!=0)
//			throw new Exception("L'utilisateur � d�j� vot�.");
...
//		if(userFull.getActualTable()==null)
//			throw new Exception("L'utilisateur n'est � aucune table. il doit �tre � une table pour demander de la quitter.");
		GameTable tableFull = userFull.getActualTable().getSame(this.tableList);
//		if(tableFull==null)
//			throw new Exception("L'utilisateur est � une table qui n'existe pas. La table doit exister pour �tre quitt�e.");
...
//			throw new Exception("Aucun vote en cours. Un vote doit �tre en cours pour voter");
		tableFull.castVote(new Vote(userFull.getLightWeightVersion(),answer,tableFull.getLightWeightVersion()));
