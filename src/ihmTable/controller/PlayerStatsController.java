...
public class PlayerStatsController {
	...
	private void setPlayerDice() throws IOException {
		...
		dice1.setProperties(false, diceContainer.widthProperty().multiply(0.3), diceContainer.heightProperty());
		...
		dice2.setProperties(false, diceContainer.widthProperty().multiply(0.3), diceContainer.heightProperty());
		...
		dice3.setProperties(false, diceContainer.widthProperty().multiply(0.3), diceContainer.heightProperty());
	}
